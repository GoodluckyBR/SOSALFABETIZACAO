...
export default function MobileStickyCTA() {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 w-full bg-white/95 backdrop-blur-md border-t border-slate-200 px-4 py-3 z-45 shadow-2xl flex items-center justify-between gap-4 animate-fade-in-up">
      <div className="text-left">
        <p className="text-[9px] uppercase font-bold text-slate-400">SOS Alfabetização</p>
        <p className="text-xs font-black text-[#0B1F3A]">Tainá Souza</p>
      </div>
